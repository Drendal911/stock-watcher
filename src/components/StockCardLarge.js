            ...
            {stock.name === "" ? null :
                <div className={stockCard.main_container}>
                    <div className={stockCard.card_container}>
                        ...
                        <div className={stockCard.price}>{stock.price} <span className={stockCard.price_span}> USD</span>
                            {stockChange ?
                                <div className={stockCard.price_change_green}>{stock.change} ({stock.changesPercentage}) Today</div>
                                :
                            <div className={stockCard.price_change_red}>{stock.change} ({stock.changesPercentage}) Today</div>}
                        </div>
